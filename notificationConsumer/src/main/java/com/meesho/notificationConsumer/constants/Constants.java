...
public class Constants {
    ...
    public static final String ELASTICSEARCH_INDEX     = "notification-requests";
    public static final String SQL_TABLE               = "sms_requests";
    public static final String THIRD_PARTY_API         = "https://api.imiconnect.in/resources/v1/messaging";
    public static final String THIRD_PARTY_API_KEY     = "c0c49ebf-ca44-11e9-9e4e-025282c394f2";
